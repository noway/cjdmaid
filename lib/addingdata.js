...
Addingdata.prototype.setDataField = function (key, value) {
	var that = this;
...
Addingdata.prototype.promptFieldEdit = function (field) {
	var that = this;
...
Addingdata.prototype.promptFieldAdd = function(field) {
	var that = this;
...
Addingdata.prototype.promptMissingFields = function () {
	var that = this;
	var neededData = {};
...
Addingdata.prototype.chooseRemoveField = function () {
	var that = this;
...
Addingdata.prototype.chooseAction = function () {
	var that = this;
