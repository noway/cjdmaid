...
function Configpath(configPath, doc, lastType) {
...
Configpath.prototype.isPossible = function () {
	...
	return {
		pointer: this.docIter
	};
};

// So we left just 1 function for working with all of this.

configpath.isPossible = function (configPath, doc, last) {
	var configpathCopy = new Configpath(configPath, doc, last);
